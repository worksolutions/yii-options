<?php
/**
 * Класс работы с опциями (оболочка массива).
 *
...
class Options implements \Serializable, \ArrayAccess {
    ...
    /**
     * Поличить опции в качестве объекта
     * (Учесть, что значением должен быть обязательно массив)
     *
     * @param string $path
     * @param null $default
     * @throws \Exception
    ...
    /**
     * Слияние с массивом или однотипным объектом
     * @param \ArrayAccess $mergedOptions
     * @return Options
     */
    ...
    /**
     * Установка значения $value по пути $path
     * @param string $path
     * @param mixed $value
     * @throws \Exception
     * @return Options
